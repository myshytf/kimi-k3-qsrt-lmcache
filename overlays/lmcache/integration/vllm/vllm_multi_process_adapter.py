...
# Modified by myshytf/kimi-k3-qsrt-lmcache.
# Backports LMCache PR #4219 while preserving the local DCP strategy extensions.
# Standard
...
class ParallelStrategy:
    mla_only: bool
    """Whether all cached tensors are MLA state replicated across TP ranks."""
    ...
    def __post_init__(self) -> None:
        ...
        if self.mla_only and self.dcp_size > 1:
            if self.pp_size != 1:
                raise ValueError(
    ...
    def kv_readers_per_object(self) -> int:
        ...
        """
        return self.kv_tp_size if self.mla_only else 1
...
class LMCacheMPWorkerAdapter:
    ...
    def register_kv_caches(
        ...
        # Keep the registered transfer context alive before the first cacheable request.
        self._ensure_heartbeat_started()
