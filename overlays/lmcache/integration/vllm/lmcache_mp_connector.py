...
# Applies group edits before registration and passes live layout hints plus DCP size.
# Standard
...
class LMCacheMPConnector(KVConnectorBase_V1, SupportsHMA):
    ...
    def register_kv_caches(self, kv_caches: dict[str, torch.Tensor]):
        ...
        # they see the same edited views. LMCache 0.5.3's unified-Mamba/Kimi-K3
        # edits require the live vLLM layout hint as well.
