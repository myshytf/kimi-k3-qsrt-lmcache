...
# Backports LMCache PR #4219 cross-TP recurrent-state keying for hybrid MLA models.
# Standard
...
def _use_multiple_attentions(model_config: "ModelConfig") -> bool:
    """Whether the model mixes attention with recurrent/linear attention."""
    return bool(getattr(model_config, "is_hybrid", False))


def mla_only(model_config: "ModelConfig") -> bool:
    """Whether every cached tensor is replicated across TP ranks."""
