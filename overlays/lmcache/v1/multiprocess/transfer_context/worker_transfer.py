...
# Backports multi-group engine-driven transfer from LMCache PR #4410 and
# adapts Kimi K3 TP8/DCP8 logical/physical cache geometry for this image.
            ...
            for gid, group in enumerate(engine_group_infos):
                ...
                g_shape = (
                    ...
                    if g_mla
                        ...
                        [2, g_num_layers, physical_window_tokens, g_hidden]
                    )
                )
